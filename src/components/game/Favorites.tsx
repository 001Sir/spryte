  ...
  return (
    <section className="mb-8">
      <div className="flex items-center gap-2.5 mb-4">
        ...
        <h2 className="text-[0.85rem] font-bold uppercase tracking-[0.06em] text-foreground">Favorites</h2>
        <span className="text-[0.7rem] text-dim">{favoriteGames.length}</span>
