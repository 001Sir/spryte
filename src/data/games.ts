...
export const games: Game[] = [
  ...
  },
  {
    slug: 'morph',
    title: 'Morph',
    description: 'A shape-shifting auto-runner. Switch between 4 forms — Runner, Ball, Glider, and Spike — each with unique physics. Chain morphs for combos, smash through walls as the Ball, soar over pits as the Glider, and ground-pound as the Spike.',
    categories: ['Action', 'Arcade'],
    controls: 'WASD to morph, Space to jump, P to pause',
    howToPlay: [
      'You auto-run forward — dodge obstacles by morphing into the right form',
      'W = Runner (balanced, can jump), A = Ball (smashes walls, bounces)',
      'S = Glider (floats over gaps and spikes), D = Spike (ground-pounds, crushes)',
      'Chain morphs without stopping to build combo multipliers',
      'Collect gems for score — combos multiply gem value',
      'Every 2000m, choose a powerful upgrade',
      'You have 3 lives — hit an obstacle you can\'t handle and you lose one',
    ],
    controlsList: [
      { key: 'W / 1', action: 'Morph to Runner' },
      { key: 'A / 2', action: 'Morph to Ball' },
      { key: 'S / 3', action: 'Morph to Glider' },
      { key: 'D / 4', action: 'Morph to Spike' },
      { key: 'Space', action: 'Jump (Runner/Ball/Glider)' },
      { key: 'P / Esc', action: 'Pause' },
    ],
    difficulty: 'Medium',
    thumbnail: '/thumbnails/morph.svg',
    color: '#f97316',
  },
  {
    slug: 'dendrite',
    title: 'Dendrite',
    description: 'Build neural pathways by connecting related concept nodes. Fire signals through your network — correct paths glow, wrong ones decay. A neuroscience-inspired word-association puzzle.',
    categories: ['Puzzle', 'Strategy'],
    controls: 'Click & drag to connect nodes, Right-click to remove, Space to fire signal',
    howToPlay: [
      'Concept nodes appear on screen with word labels from different categories',
      'Click and drag between nodes to create axon connections (glowing lines)',
      'Connect semantically related words — "whale" to "ocean", "heart" to "lung"',
      'Press Space to fire a signal from the green START node to the gold TARGET',
      'The signal travels your connections — correct paths glow, wrong ones decay',
      'Score based on path efficiency, speed, and streak multiplier',
      'You have 3 lives — lose one if the signal can\'t reach the target',
    ],
    controlsList: [
      { key: 'Click & Drag', action: 'Create connection between nodes' },
      { key: 'Right Click', action: 'Remove a connection' },
      { key: 'Space', action: 'Fire signal' },
      { key: 'P', action: 'Pause' },
    ],
    difficulty: 'Medium',
    thumbnail: '/thumbnails/dendrite.svg',
    color: '#a855f7',
    isNew: true,
  },
  {
    slug: 'phylo',
    title: 'Phylo',
    description: 'Creatures appear with visible traits — body type, covering, limbs, eyes, and patterns. Place them on a branching evolutionary tree based on shared characteristics. Wrong placements crack branches.',
    categories: ['Puzzle', 'Strategy'],
    controls: 'Click to place creature on a branch, Enter to start',
    howToPlay: [
      'Procedurally generated creatures appear with visible traits (body, legs, covering, eyes, pattern)',
      'A branching evolutionary tree grows from the bottom of the screen',
      'Click a branch endpoint to place the new creature there',
      'Correct placement = creature shares most traits with branch neighbors, tree grows',
      'Wrong placement = branch cracks — 3 mistakes and the tree collapses',
      'Watch for convergent evolution curveballs — looks can be deceiving!',
      'Build streaks for score multipliers up to 3x',
    ],
    controlsList: [
      { key: 'Click', action: 'Place creature on branch' },
      { key: 'Enter / Space', action: 'Start / Play again' },
    ],
    difficulty: 'Medium',
    thumbnail: '/thumbnails/phylo.svg',
    color: '#10b981',
    isNew: true,
  },
  {
    slug: 'convect',
    title: 'Convect',
    description: 'Place heat sources and cold sinks to create convection currents. Particles ride the flow to goal zones — you never touch the particles directly. A thermodynamics puzzle with real fluid physics.',
    categories: ['Puzzle', 'Physics'],
    controls: 'Left-click to place heat, Right-click for cold, Space to simulate',
    howToPlay: [
      'Click on the grid to place heat sources (red) — hot air rises',
      'Right-click or Shift+click to place cold sinks (blue) — cold air sinks',
      'Together they create circular convection currents in the fluid',
      'Floating particles are carried by the flow field toward goal zones',
      'Press Space to start the simulation — sources lock in place',
      'Guide all particles to their goals using limited heat and cold sources',
      'Later levels add walls, ice blocks that melt, and steam vents',
    ],
    controlsList: [
      { key: 'Left Click', action: 'Place heat source / remove source' },
      { key: 'Right Click / Shift+Click', action: 'Place cold sink' },
      { key: 'Space', action: 'Start simulation' },
      { key: 'R', action: 'Reset level' },
    ],
    difficulty: 'Medium',
    thumbnail: '/thumbnails/convect.svg',
    color: '#ef4444',
    isNew: true,
  },
  {
    slug: 'phase-shift',
    title: 'Phase Shift',
    description: 'An auto-scrolling runner across two overlapping dimensions. Toggle between Phase A (cyan) and Phase B (magenta) — obstacles in your active phase are solid, the other phase is ghosted. Four movement modes (Dash, Glide, Flip, Wave) activated by portals mid-level. 10 hand-crafted levels of escalating difficulty.',
    categories: ['Action', 'Arcade'],
    controls: 'Space/W to jump, Shift/X to phase shift, P to pause',
    howToPlay: [
      'You auto-scroll forward — jump over obstacles and land on platforms',
      'Press Shift or X to toggle between Phase A (cyan) and Phase B (magenta)',
      'Objects in your active phase are solid — the other phase is ghosted and passthrough',
      'Hit portals to switch movement modes: Dash (jump), Glide (fly), Flip (invert gravity), Wave (diagonal)',
      'Collect 3 stars per level for bonus points — some stars require a specific phase',
      'Complete all 10 levels with increasing speed and complexity',
    ],
    controlsList: [
      { key: 'Space / W / Up', action: 'Jump / Fly / Flip / Wave' },
      { key: 'Shift / X / Down', action: 'Phase Shift (toggle dimension)' },
      { key: 'P / Esc', action: 'Pause' },
      { key: 'R', action: 'Restart level' },
      { key: 'Touch Left', action: 'Jump / Action' },
      { key: 'Touch Right', action: 'Phase Shift' },
    ],
    difficulty: 'Hard',
    thumbnail: '/thumbnails/phase-shift.svg',
    color: '#00ffff',
    isNew: true,
  },
];
